            ...
            {!isMobile && ( // Десктопта ғана көрінетін элементтер
                ...
                >
                  ...
                  >
                    ...
                    <MenuItem component={NavLink} to="/3d-map" onClick={handleMenuClose}>
                      {t('header.3d_tour')}
                    </MenuItem>
            ...
            >
              {user && (
                  <>
                    ...
                    {user.role === 'guide' && (
                        <MenuItem component={NavLink} to="/guide/tours" onClick={handleUserMenuClose}>
                          Мои туры гида
                        </MenuItem>
                    )}
                    {user.role === 'hotel_owner' && (
                        <MenuItem component={NavLink} to="/owner/hotels" onClick={handleUserMenuClose}>
                          Мои отели
                        </MenuItem>
                    )}
